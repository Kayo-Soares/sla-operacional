...
BASES_ORGANIZACAO = pd.DataFrame([
    ...
    ("F BRV-PA","Breves","ORLEAN NASCIMENTO","CLAYTON WALLACE"),
    ...
    ("MCP FLUVIAL -AP","Macapá","ORLEAN NASCIMENTO","ALANA NASCIMENTO"),
    ("F MCP-AP","Macapá","ORLEAN NASCIMENTO","ALANA NASCIMENTO"),
    ("F MCP 02-AP","Macapá","ORLEAN NASCIMENTO","ALANA NASCIMENTO"),
    ("F MCP 04-AP","Macapá","ORLEAN NASCIMENTO","ALANA NASCIMENTO"),
    ("F MAC-AP","Macapá","ORLEAN NASCIMENTO","ALANA NASCIMENTO"),
    ("MCP-AP","Macapá","ORLEAN NASCIMENTO","ALANA NASCIMENTO"),
    ...
    ("F PDP-PA","Ponta de Pedras","ORLEAN NASCIMENTO","CLAYTON WALLACE"),
    ("ANA FLUVIAL - PA","Ananindeua","ORLEAN NASCIMENTO","CLAYTON WALLACE"),
    ("F CRH-PA","Curralinho","ORLEAN NASCIMENTO","CLAYTON WALLACE"),
    ...
    ("F CAM-PA","Belém","ORLEAN NASCIMENTO","WALLESON BRAGA VIEIRA"),
    ("F PDR-PA","Belém","ORLEAN NASCIMENTO","WALLESON BRAGA VIEIRA"),
    ("F TNN-PA","Belém","ORLEAN NASCIMENTO","WALLESON BRAGA VIEIRA"),
